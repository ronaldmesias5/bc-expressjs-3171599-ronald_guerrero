...
import * as service from '../services/part.service.js';
import { createPartSchema, updatePartSchema, idSchema } from '../schemas/index.js';
...
export async function getById(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const part = await service.findById(parsed.data);
    res.json({ data: part });
  } catch (err) {
    next(err);
  }
...
export async function create(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const dto: CreatePartDto = result.data;
    const part = await service.create(dto);
...
export async function update(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const dto: UpdatePartDto = result.data;
